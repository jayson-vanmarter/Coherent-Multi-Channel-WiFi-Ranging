...
% Move all additional measurement dimensions (e.g., antennas, downsampling
% offsets, time, etc.) to the second dimension
...
% Combine covariance esimates across antennas
