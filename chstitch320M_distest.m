...
% parameters, and does downsampling before passing the multi-channel stitched
% CFR data to music1_est for distance estimation using MUSIC.
%
% Inputs:
...
K_Dr = floor((K_B - Dr)/Dr) + 1; % Number of CFR measurements after downsampling and truncation
